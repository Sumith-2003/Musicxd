...
namespace Musicxd.API.Migrations
{
    ...
    public partial class FreshStart : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FavouriteAlbumLists",
                columns: table => new
                {
                    FavouriteAlbumListId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteAlbumLists", x => x.FavouriteAlbumListId);
                    table.ForeignKey(
                        name: "FK_FavouriteAlbumLists_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lists_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "ProfileId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumFavAlbumLists", x => new { x.AlbumId, x.FavouriteAlbumListId });
                    table.ForeignKey(
                        name: "FK_AlbumFavAlbumLists_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumFavAlbumLists_FavouriteAlbumLists_FavouriteAlbumListId",
                        column: x => x.FavouriteAlbumListId,
                        principalTable: "FavouriteAlbumLists",
                        principalColumn: "FavouriteAlbumListId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumLists", x => new { x.AlbumId, x.ListId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumLists_Lists_ListId",
                        column: x => x.ListId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumFavAlbumLists_FavouriteAlbumListId",
                table: "AlbumFavAlbumLists",
                column: "FavouriteAlbumListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteAlbumLists_ProfileId",
                table: "FavouriteAlbumLists",
                column: "ProfileId",
                unique: true);
